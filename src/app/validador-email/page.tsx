...
const metadata: Metadata = {
  ...
  description:
    "Validador de email online gratuito. Verifique se um endereço de email é válido instantaneamente. Ferramenta rápida e segura.",
  keywords: [
    "validador email",
    "verificar email",
    "email válido",
  ...
  openGraph: {
    ...
    description:
      "Validador de email online gratuito. Verifique se um endereço de email é válido instantaneamente.",
    url: "/validador-email",
  },
};
...
function validateEmail(email: string): { isValid: boolean; issues: string[] } {
  ...
  if (parts.length === 2) {
    ...
    if (localPart.length === 0) {
      ...
      issues.push(
        "Parte local (antes do @) muito longa (máximo 64 caracteres)"
      );
    }
...
function getEmailInfo(
  email: string
): { domain: string; tld: string; isCommonProvider: boolean } | null {
  const parts = email.split("@");
                    ...
                    <div className="flex-1">
                      ...
                      {validation.isValid ? (
                        <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                          Este email possui um formato válido e passou em todas
                          as verificações.
                        </p>
                      ) : (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  Esta ferramenta verifica apenas se o formato do email está
                  correto. Ela não verifica se o email realmente existe ou se a
                  caixa de entrada está ativa.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Um email válido significa que possui formato correto segundo
                  os padrões RFC, mas não garante que a conta existe ou está
                  ativa.
                </div>
              </details>
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Não, fazemos apenas a validação do formato e estrutura. Para
                  verificar se um email realmente existe, seria necessário
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  ...
                  nem armazenamos nenhum email digitado em nossos servidores.
                </div>
              </details>
            </div>
          </div>
