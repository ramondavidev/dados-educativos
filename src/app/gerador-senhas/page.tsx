...
const metadata: Metadata = {
  ...
  description:
    "Gerador de senhas seguras online gratuito. Crie senhas fortes com diferentes níveis de complexidade, caracteres especiais e comprimentos personalizáveis.",
  keywords: [
    "gerador senha",
    "senha segura",
    "gerar senha",
  ...
  openGraph: {
    ...
    description:
      "Gerador de senhas seguras online gratuito. Crie senhas fortes com diferentes níveis de complexidade.",
    url: "/gerador-senhas",
  },
};
...
const toolSchema = {
  ...
  description:
    "Ferramenta online gratuita para gerar senhas seguras e personalizáveis",
  url: `${
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-green-800 dark:text-green-300">
                  Suas senhas são geradas localmente no seu navegador e nunca
                  são enviadas para nossos servidores. Recomendamos usar um
                  gerenciador de senhas para armazenar suas senhas com
                  segurança.
                </p>
              </div>
            </div>
