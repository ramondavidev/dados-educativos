...
const metadata: Metadata = {
  ...
  description: "Validador de CPF online gratuito. Verifique se um CPF é válido instantaneamente. Ferramenta rápida, segura e sem armazenamento de dados.",
  keywords: ["validador cpf", "verificar cpf", "cpf válido", "validar cpf", "checkar cpf"],
  openGraph: {
    title: "Validador de CPF - Verifique CPFs Online",
    description: "Validador de CPF online gratuito. Verifique se um CPF é válido instantaneamente.",
    url: "/validador-cpf",
  },
};
...
const toolSchema = {
  ...
  url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://localhost:3000"}/validador-cpf`,
        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Verifique se um CPF é válido instantaneamente. 
              Digite ou cole o CPF e receba o resultado imediatamente.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  Esta ferramenta verifica apenas se o CPF é válido matematicamente (dígitos verificadores corretos). 
                  Ela não verifica se o CPF realmente existe ou se pertence a uma pessoa específica.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="font-medium text-gray-900 dark:text-white">Preciso</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-4">
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Um CPF válido significa que os dígitos verificadores estão corretos segundo o algoritmo 
                  da Receita Federal, mas não garante que o CPF pertence a uma pessoa real.
                </div>
              </details>
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Não, fazemos apenas a validação matemática dos dígitos verificadores. 
                  Para consultar se um CPF realmente existe, use o site oficial da Receita Federal.
                </div>
              </details>
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  ...
                  armazenamos nenhum CPF digitado em nossos servidores.
                </div>
              </details>
            </div>
          </div>
