...
const metadata: Metadata = {
  title:
    "Gerador de CNPJ - Gere CNPJs Válidos para Testes | Ferramentas Online",
  description:
    "Gerador de CNPJ online gratuito. Gere CNPJs válidos para testes e desenvolvimento de sistemas. Ferramenta rápida e segura, sem armazenamento de dados.",
  keywords: [
    "gerador cnpj",
    "cnpj válido",
    "gerar cnpj",
  ...
  openGraph: {
    ...
    description:
      "Gerador de CNPJ online gratuito. Gere CNPJs válidos para testes e desenvolvimento de sistemas.",
    url: "/gerador-cnpj",
  },
};
...
const toolSchema = {
  ...
  description:
    "Ferramenta online gratuita para gerar CNPJs válidos para testes e desenvolvimento",
  url: `${
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  Este CNPJ é válido matematicamente, mas não pertence a nenhuma
                  empresa real. Use apenas para testes, desenvolvimento de
                  sistemas ou demonstrações. Não utilize para fins fraudulentos
                  ou ilegais.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Não, o CNPJ é válido matematicamente (passa na validação do
                  algoritmo), mas não pertence a nenhuma empresa real. É gerado
                  aleatoriamente apenas para testes.
                </div>
              </details>
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Os dígitos 0001 representam a matriz da empresa (primeira
                  filial). É o padrão mais comum para empresas que possuem
                  apenas uma unidade.
                </div>
              </details>
              ...
              <details className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="px-4 pb-4 text-gray-600 dark:text-gray-400">
                  Apenas para testes de sistemas, desenvolvimento de software,
                  preenchimento de formulários de teste, demonstrações e fins
                  educacionais.
                </div>
              </details>
            </div>
